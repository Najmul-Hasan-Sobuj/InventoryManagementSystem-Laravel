...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Supplier Create</h5>
        ...
        <div class="panel-body">
            ...
            <form id="" class="form-horizontal form-validate-jquery" action="{{ route('supplier.store') }}" method="POST"
                ...
                <fieldset class="content-group">
                    ...
                    <!-- /experience field -->
                    <div class="form-group">
                        <label class="control-label col-lg-2">Supplier Photo</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="shop" class="form-control" id="shop" placeholder="Enter your Shop">
                        </div>
                    </div>
                    <div class="form-group">
